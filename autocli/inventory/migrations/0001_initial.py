...
import inventory.base_model.validators
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('devices', models.ManyToManyField(help_text='All devices that belongs to current folder.', to='inventory.device', verbose_name='Devices')),
