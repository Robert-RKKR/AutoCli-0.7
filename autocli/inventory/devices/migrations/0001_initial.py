# Generated by Django 4.0.7 on 2022-08-20 09:26

from django.db import migrations, models
import django.db.models.deletion
import inventory.all.base_model.validators.base_validators
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.ManyToManyField(help_text='Related tags.', to='tags.tag', verbose_name='Tag')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='device',
            name='tag',
            field=models.ManyToManyField(help_text='Related tags.', to='tags.tag', verbose_name='Tag'),
        ),
        migrations.CreateModel(
