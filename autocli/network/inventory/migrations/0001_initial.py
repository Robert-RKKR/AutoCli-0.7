    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credential', models.ForeignKey(blank=True, help_text='Credential needed to establish SSH / HTTPS connection.', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='devices', to='inventory.credential', verbose_name='Credential')),
            ],
            options={
                'verbose_name': 'Device',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('root_folder', models.ForeignKey(blank=True, help_text='The parent folder to witch the current folder belongs.', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='child_folders', to='inventory.group', verbose_name='Root folder')),
                ('tag', models.ManyToManyField(blank=True, help_text='Related tags.', to='tags.tag', verbose_name='Tag')),
            ],
            options={
                'verbose_name': 'Group',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_data_corelation', models.IntegerField(choices=[(0, 'None'), (1, 'Device data'), (2, 'Interface data'), (3, 'Routing data'), (4, 'Access list data')], default=0, help_text='Device update status.', verbose_name='Update status')),
                ...
                ('device_type', models.ForeignKey(help_text='Type of network device system.', on_delete=django.db.models.deletion.PROTECT, related_name='device_type_templates', to='inventory.devicetype', verbose_name='Device type')),
            ],
            options={
